...
function createIncidentMarkers(incidents, map, iconsBase) {
    ...
    for (i = 0; i < incidents.length; i++) {
        ...
        ` + incidents[i].Description + `
         ...
         `<object id = 'map' data='http://ec2-34-210-155-178.us-west-2.compute.amazonaws.com:3000/incidentpreview/` + incidents[i].IncidentID +  `' width='100%' height='100px' type='text/html'> <object/> `
