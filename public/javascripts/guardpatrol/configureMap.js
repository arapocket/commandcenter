...
function createIncidentMarkers(incidents, map, iconsBase) {
    ...
    for (i = 0; i < incidents.length; i++) {
        ...
        <a href = "https://s3-us-west-2.amazonaws.com/foxwatch/lqyv9xq8x"><img src="https://s3-us-west-2.amazonaws.com/foxwatch/`
            + incidents[i].IncidentID + `"height="150" width="150" href = ""  ></a>`
