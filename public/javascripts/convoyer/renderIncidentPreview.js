function renderIncidentPreview() {
    ...
    if (incident[0].Media == 'photo') {
        ...
        imageAnchor.href = "http://ec2-34-210-155-178.us-west-2.compute.amazonaws.com:3000/incidentdetailsmap/" + incident[0].IncidentID
    ...
    if (incident[0].Media == 'video') {
        ...
        videoAnchor.href = "http://ec2-34-210-155-178.us-west-2.compute.amazonaws.com:3000/incidentdetailsmap/" + incident[0].IncidentID
