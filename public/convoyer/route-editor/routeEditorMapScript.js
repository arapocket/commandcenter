...
function initMap() {
    ...
    function onSaveArea(marker) {
        ...
        bootbox.prompt("Enter a name for the patrol area.", function (result) {
            if (result === null) {
                ...
                xhr.open("POST", "http://ec2-54-212-237-195.us-west-2.compute.amazonaws.com:3000/patrolareas", true);
    ...
    function onDeleteArea() {
        ...
        xhr.open("GET", "http://ec2-54-212-237-195.us-west-2.compute.amazonaws.com:3000/patrolareas/", true);
    ...
    function setSelectedAreaAsCurrent(areaID) {
        ...
        xhr.open("PUT", "http://ec2-54-212-237-195.us-west-2.compute.amazonaws.com:3000/patrolareas", true);
        ...
        bootbox.confirm({
            ...
            callback: function (result) {
                ...
                if (result) {
                    ...
                    xhr.open("DELETE", "http://ec2-54-212-237-195.us-west-2.compute.amazonaws.com:3000/checkpoints/" + routeID, true);
        ...
        bootbox.confirm({
            ...
            callback: function (result) {
                ...
                if (result) {
                    ...
                    xhr.open("DELETE", "http://ec2-54-212-237-195.us-west-2.compute.amazonaws.com:3000/patrolareas/" + areaID, true);
    ...
    function deleteRoute(routeID) {
        ...
        xhr.open("DELETE", "http://ec2-54-212-237-195.us-west-2.compute.amazonaws.com:3000/routes/" + routeID, true);
