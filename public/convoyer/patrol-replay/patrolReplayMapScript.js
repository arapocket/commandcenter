        ...
        for (let i = 0; i < incidents.length; i++) {
            ...
            if (incidents[i].Media != 'none') {
                windowString = `<h3  style="text-align: center">` + incidents[i].Type + ` </h3> 
                    <div style="text-align: center"> <p>` + incidents[i].Description + `</p> </div> <div text-align = 'center'> <object id = 'map' data='http://ec2-52-33-195-216.us-west-2.compute.amazonaws.com:3000/incidentpreview/` + incidents[i].IncidentID + `' width='100%' height='100%' type='text/html'> <object/> </div>
                    `;
            } else {
                windowString = `<h3  style="text-align: center">` + incidents[i].Type + ` </h3> 
